...
sec_pred = 5
CLASSES = ["airplane", "apple", "bee", "ice cream", "tree", "nothing"]

model = tf.keras.models.load_model(r"C:\Users\nicho\SML-Final-main\my_model.h5")
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                if not is_drawing and is_shown:
                    cv2.putText(image, "You are drawing " + CLASSES[sec_pred], (100,50), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0, 255, 0), 5,cv2.LINE_AA)
